...
outfile = "processed/csebuetnlp_paraphrase_v2.csv"
...
df_all = df_all.rename(columns={"target": "text"})
print(df_all.head())
...
df_all.to_csv("processed/csebuetnlp_paraphrase_5k_v2.csv", index=False)
