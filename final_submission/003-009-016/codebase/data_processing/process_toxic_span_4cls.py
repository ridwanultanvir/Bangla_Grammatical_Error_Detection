...
if __name__ == "__main__":
  ...
  print(stat)
  df.to_csv("processed_data/DataSetFold1_processed_4cls.csv", index=False)
  ...
  train.to_csv("processed_data/train_4cls.csv", index=False)
  test.to_csv("processed_data/test_4cls.csv", index=False)
