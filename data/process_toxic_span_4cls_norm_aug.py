...
if __name__ == "__main__":
  ...
  # df = df.append(df2)
  augfile = './Aug2/data_v2_processed_20000_with_error_clean.csv'
  ...
  trainfile = '../ninth_place_tsd/data/vasha23_4cls/train_4cls_norm.csv'
  outfile = '../ninth_place_tsd/data/vasha23_4cls/train_4cls_norm_aug.csv'
  df_train = pd.read_csv(trainfile)
  
  df_train = df_train.append(df)
  df_train.to_csv(outfile, index=False)
